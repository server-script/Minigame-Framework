...
local function point3d(cf, parent, color)
...
local function line3d(a, b, parent, color)
	color = color or Color3.new(1, 1, 0);
	local l = draw3d{
		CFrame = CFrame.new((a + b)/2, b);
		Size = Vector3.new(0.2, 0.2, (b - a).magnitude);
		Color = color;
		Parent = parent;
	};
	MESH:Clone().Parent = l;
...
local function ray3d(o, v, parent, color)
	return line3d(o, o + v, parent, color);
end

local function cframe3d(cf, parent, color)
